...
/**
 * Special credit to zeyuanxy
 * as in https://github.com/EdisonCodeKeeper/course-6.830-database-systems/tree/master/6.830/src/java/simpledb
 */

public class LockManager {

    private ConcurrentMap<PageId, Object> locks;
    private Map<PageId, List<TransactionId>> sharedLocks;
    private Map<PageId, TransactionId> exclusiveLocks;
    private ConcurrentMap<TransactionId, Collection<PageId>> pageIdsLockedByTransaction;
    private ConcurrentMap<TransactionId, Collection<TransactionId>> dependencyGraph;
