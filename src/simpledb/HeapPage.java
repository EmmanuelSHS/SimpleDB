...
public class HeapPage implements Page {
    ...
    HeapPageId pid;
    TupleDesc td;
    byte header[]; // for indication of full/empty of single slot
    Tuple tuples[];
    int numSlots;
    boolean isDirty;
    ...
    */
    private int getNumTuples() {        
    	TupleDesc td = Database.getCatalog().getTupleDesc(pid.getTableId());  
        return (int)Math.floor(BufferPool.PAGE_SIZE * 8.0f / (td.getSize() * 8 + 1));
    }
    ...
    private int getHeaderSize() {        
        int headerBytes = (int) Math.ceil(getNumTuples()/8.0f);
    ...
    public void deleteTuple(Tuple t) throws DbException {
        ...
        if (!getSlot(t.getRecordId().tupleno())) {
    ...
    public void addTuple(Tuple t) throws DbException {
        ...
        if (!t.getTupleDesc().equals(td)) {
        	throw new DbException("Mismatched incoming tuple description");
        }
    ...
    private int nextEmptySlot() throws DbException {
     ...
     * @param i the tupleno of a record, also 0->nslots
     */
    public boolean getSlot(int i) {
        int idx = Math.round(i / 8);
        int bits = i % 8;

        return ((header[idx] >> bits) & 0x01) == 1;
    }
